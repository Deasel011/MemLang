...
(15hours+) have been devoted into the real-time Interpretor to run MemLang.

Since MemLang has only been (up to now) built in W10, it only supports programs in 64bits in W10... Most of the more secured programs (with the new W10 security) have not been cracked :( ... Though, alot of Steam games from small studios are :)!!!

In the near future, executing commands on defined addresses should also
be right around the corner, memory search for string support should be added. As time progresses, more granular memory tasks will make their way into MemLang.
